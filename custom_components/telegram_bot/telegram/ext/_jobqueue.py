...
# --- FIX START: Import necessario per Home Assistant ---
import pytz
# --- FIX END ---
import warnings
# --- FIX START: Soppressione Warning apscheduler ---
# Ignoriamo il warning di pkg_resources deprecato generato da apscheduler
...
class JobQueue(Generic[CCT]):
    ...
    def __init__(self) -> None:
        ...
        # --- FIX START: Forzatura Timezone Init ---
        config = self.scheduler_configuration
        # Forzo pytz.utc nell'inizializzazione
    ...
    def scheduler_configuration(self) -> JSONDict:
        ...
        """
        # --- FIX START: Forzatura Timezone Property ---
        # Ignoriamo la logica originale che cerca di indovinare il timezone dal bot
        # e restituiamo SEMPRE pytz.utc per soddisfare apscheduler vecchio.
        return {
            "timezone": pytz.utc,
