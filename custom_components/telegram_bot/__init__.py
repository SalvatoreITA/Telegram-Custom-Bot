...
from __future__ import annotations  # <--- QUESTA DEVE ESSERE LA PRIMA RIGA!

import sys
import os
import logging

# --- INIZIO MODIFICA VENDORING ---
# Questo blocco deve stare SUBITO DOPO 'from __future__' ma PRIMA di altri import
current_path = os.path.dirname(os.path.abspath(__file__))
# Aggiungo il path in cima alla lista
...
try:
    import telegram
    logging.getLogger(__name__).warning(f"TELEGRAM OK: Sto caricando la libreria da: {telegram.__file__}")

except ImportError:
    logging.getLogger(__name__).error("VERIFICA TELEGRAM: Impossibile importare la libreria telegram locale!")
# --- FINE MODIFICA VENDORING ---

from ipaddress import IPv4Network, ip_network
from types import ModuleType
from typing import Any

# Ora importiamo le dipendenze che useranno la libreria locale
